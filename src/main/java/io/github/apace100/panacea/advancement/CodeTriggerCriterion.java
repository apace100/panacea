package io.github.apace100.panacea.advancement;
...
public class CodeTriggerCriterion extends AbstractCriterion<CodeTriggerCriterion.Conditions> {
    ...
    public static final Identifier ID = new Identifier(Panacea.MODID, "code_trigger");

    public Identifier getId() {
        return ID;
    }

    public CodeTriggerCriterion.Conditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
